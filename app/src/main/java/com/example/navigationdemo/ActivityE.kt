...
class ActivityE : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val nextClassName = ActivityF::class.java.name
            ActivityScreen(
                activityName = "E",
                dataFromH = dataFromH.value,
                onTargetClick = { startNextScreen(nextClassName, ActivityE::class.java.name) },
    ...
    private fun printActivityBackStack() {
        ...
        Log.d("ActivityTracker: Activity E", "Current Activity Back Stack: $activityNames")
    }
